...
class ExelemField(object):
    ...
    def __init__(self, f, exelem):
        ...
        declaration = f.readline().split(',')
        print "field declaration[0]: " + declaration[0]
        print "field declaration[1]: " + declaration[1]
        print "field declaration[2]: " + declaration[2]
        print "field declaration[3]: " + declaration[3]
        index, self.name = read_string_regex(f, declaration[0],
                r'([0-9]+)\)\s+([A-Za-z0-9_\s\/]+)')
        self.index = int(index)
        self.num_components = int(read_string_regex(f, declaration[3],
...
class ExelemComponent(object):
    ...
    def __init__(self, f, field):
        ...
        print "component declaration[0]: " + declaration[0]
        print "component declaration[1]: " + declaration[1]
        print "component declaration[2]: " + declaration[2]
