...
basis.type = CMISS.BasisTypes.SIMPLEX	# GB
basis.numberOfXi = 3
#basis.interpolationXi = [CMISS.BasisInterpolationSpecifications.LINEAR_LAGRANGE]*3
basis.interpolationXi = [CMISS.BasisInterpolationSpecifications.LINEAR_SIMPLEX]*3
...
inputNodes = exfile.Exnode("simplexresults"+".exnode")
inputElems = exfile.Exelem("simplexresults"+".exelem")
#inputNodes = exfile.Exnode("LinearTetrahedraSimplex.part0"+".exnode")
#inputElems = exfile.Exelem("LinearTetrahedraSimplex.part0"+".exelem")
...
equationsSetField = CMISS.Field()
equationsSet = CMISS.EquationsSet()
#equationsSetSpecification = [CMISS.EquationsSetClasses.CLASSICAL_FIELD,
#        CMISS.EquationsSetTypes.LAPLACE_EQUATION,
#        CMISS.EquationsSetSubtypes.STANDARD_LAPLACE]
equationsSet.CreateStart(equationsSetUserNumber,region,geometricField,
...
# Try this...
#problem = CMISS.Problem()
#problemSpecification = [CMISS.ProblemClasses.CLASSICAL_FIELD,
#        CMISS.ProblemTypes.LAPLACE_EQUATION,CMISS.ProblemSubtypes.STANDARD_LAPLACE]
...
# Export results - THIS DOES NOT WORK
#baseName = "laplace"
